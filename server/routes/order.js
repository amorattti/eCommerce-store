...
const { createOrder, listOrdersAdmin, getStatusOrders, updateStatus } = require('../controllers/order')
...
router.put('/order/update-status/:userId', requireSignin, isAuth, isAdmin, updateStatus)
